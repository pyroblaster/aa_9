...
interface TaskieInteractor {
    ...
    fun getTask(id:String, getTaskCallback: Callback<BackendTask>)
    ...
    fun deleteTask(taskId:String, getDeleteTaskCallback: Callback<DeleteTaskResponse>)

    fun editTask(request: EditTaskRequest,getEditNoteCallback: Callback<BackendTask>)
}